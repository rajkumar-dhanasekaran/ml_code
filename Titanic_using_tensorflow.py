...
m = tf.contrib.learn.LinearClassifier(
    feature_columns=[Age, Fare, SibSp, Parch, Sex], model_dir=model_dir
)
#''', Pclass,Embarked'''
...
# y = m.fit(input_fn=predict_input_fn, steps=200)
print("Predictions: {}".format(str(y)))
df_output = pd.DataFrame()
df_output["PassengerId"] = data1["PassengerId"]
df_output["Survived"] = y
df_output[["PassengerId", "Survived"]].to_csv(
    "/Users/Cipher/Downloads/ML_Training/ML_Training/tensor_flow_output.csv",
    index=False,
)
